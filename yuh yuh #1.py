...
#sets background color fpr entire window
root.configure(background="royal blue")

#how to insert a jpg image
img=ImageTk.PhotoImage(Image.open ("dice 1.png"))

player1 = Label(root, text = "Player 1", bg = "orange", fg = "black")
player1.place(relx = 0.1, rely = 0.3, anchor = CENTER)

player2 = Label(root, text = "Player 2", bg = "orange", fg = "black")
player2.place(relx = 0.9, rely = 0.3, anchor = CENTER)

player_1_score_label = Label(root , bg = "orange", fg = "black")
player_1_score_label.place(relx = 0.1, rely = 0.4 , anchor = CENTER)

player_2_score_label = Label(root , bg = "orange", fg = "black")
...
def player1():
    ...
    player1score_label["text"] = str(player1_score)
...
def player2():
    ...
    player2score_label["text"] = str(player2_score)
